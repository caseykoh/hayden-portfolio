  ...
  return (
    <>
      <div className="relative bg-slate-400 py-[16vw]" id="work">
        <h1 className="absolute top-[-7vw] md:top-[0vw] whitespace-nowrap text-[25vw] md:text-[15vw] lg:text-[18vw] tracking-tighter w-full text-center font-sans font-medium text-white">
          [Hayden Koh]
        </h1>
